	...
	<?php foreach($products as $product) :?>
		<div>
			<a class="product-link" href="/product.php?id=<?= \Cm\Shop\Helper\Renderer::e($product['id']) ?>">
				...
				<p class="category">Category: <a class="category-link" href="../category.php?id=<?= \Cm\Shop\Helper\Renderer::e($product['cat_id'])?>"><?= \Cm\Shop\Helper\Renderer::e($product['category_name']) ?></a></p>
				<hr/>
				<div class="flex-space-between">
					<a class="add-cart" href="#"><span class="material-icons-outlined">add_shopping_cart</span> </a>
